...
import openfl.Lib;
import idea.states.menus.options.Options;
	...
	override function create() {
		...
		/*options = [
			...
			new OptionCata(640, 40, "Misc", [
				...
				new Option("Anti-Aliasing", "Toggle anti-aliasing, improving graphics quality at a slight performance penalty.", "globalAntialiasing", bool),
