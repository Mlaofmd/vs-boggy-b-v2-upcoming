...
class Conductor
{
	...
	public static function judgeNote(note:Note, diff:Float = 0, data:Array<Rating>):Rating {
...
class Rating
{
	...
	public static var defaults(get, never):Array<Rating>;
	...
	public static function get_defaults():Array<Rating> {
